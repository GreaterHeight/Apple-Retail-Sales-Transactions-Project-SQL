...
**Get the guided project/datasets here**: [Get the Project Datasets](https://topmate.io/thesegunsamuel/1705273)
...
![ERD](https://github.com/GreaterHeight/Apple-Retail-Sales-Transactions-Project-SQL/blob/main/AppleRetailSales-ERD.png)
